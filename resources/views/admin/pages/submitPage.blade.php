                                ...
                                <div id="feedbackModal"
                                    ...
                                    <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                                        ...
                                        <form id="feedbackForm" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-4">
                                                <label for="file"
                                                    class="block text-sm font-medium text-gray-700">Attach PDF
                                                    (Optional)</label>
                                                <input type="file" name="file" id="file"
                                                    class="form-control mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm"
                                                    accept=".pdf" />
                                            </div>
                                            ...
                                            <div class="flex justify-end space-x-4">
                                                ...
                                                <!-- Submit Button -->
                                                <button type="submit"
                                                    class="text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md">Send
                                                    Feedback</button>
                                            </div>
                                        </form>
                                    </div>
